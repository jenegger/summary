...
with $\Delta\Theta{out} = 5.431e-04$\\
Hence:\\
$\Big|\frac{\Delta\rho{\Theta{out}}}{\rho}\Big| = \frac{1}{2\cdot\tan(\frac{\Theta{in}+\Theta{out}}{2})}\cdot\Delta\Theta{out} = $1.724e-03
...
$\Big|\frac{\Delta\rho}{\rho}\Big| = \sqrt{(5.434\cdot10^{-4})^{2}+(1.724\cdot10^{-3})^{2}+(1.104\cdot10^{-3})^{2}} = 2.12\cdot10^{-3} $
