...
\begin{tabular}{|c|c|c|}
\hline
Detnr. TOFW & Time offset 39-61 [ns] & Time offset 36 [ns] \\
\hline
1      &	114.916	&	114.4    \\
2	   &	113.592	&	113.588  \\
3	   &	116.172	&	116.132  \\
...
10B: $4.49 < Z < 5.35 $ and $6131 < \rho < 6786$\\
11B: $4.34 < Z < 5.48$ and $6820 < \rho < 7505$\\
11C: $5.54 < Z < 6.61$ and $5720 < \rho < 6216$\\
12C: $5.42 < Z < 6.7$ and $6247 < \rho < 6850$\\
\newline
...
\hline
\textbf{10B:} & 0.3202 & 0.000143964 & 0.327888\\
\hline
\textbf{11B:} & 0.2934 & 0.000140786 & 0.313639\\
\hline
\textbf{11C:} & 0.3461 & 0.000146043 & 0.340846\\
\hline
\textbf{12C:} & 0.3178 & 0.000143976 & 0.326675\\
\hline
\end{tabular}
\\
\newline
...
\section{Set by step discrimination of the isotopes}
\begin{itemize}
\item Plot the charge values of the particles going through TWIM Music and make a gauss fit on them. The intersection of the two gaussians is the charge cut betweeen Z = 5 and Z = 6.
\item Plot A/q  versus time of flightfor both charges using the derived formula for $\rho$
\item Project the plot to the A/q axis and make two gaussian fits on both Z = 5 and Z = 6. The intersection between the gaussians give you the mass cuts between 11C and 12C (10B and 11B).
\item Now plot for each isotope theta \textunderscore out vs x\textunderscore MW3. Make a linear fit on it and extract from it the parameters $\alpha$, a and b (for the formula: $theta \textunderscore in = \alpha - a\cdot x\textunderscore MW3 -b$)
\item Now calculate again A/q for each isotope using the formula for $\rho$ but now with the formula for theta \textunderscore in from the previous step
\end{itemize}
...
\section{Trigger patterns for S444- February 2020}
\begin{itemize}
\item tpat 1 = spill on + sofstart
\item tpat 2 = spill on + sofstart + califa
\item tpat 3 = spill on + sofstart + neuland
\item tpat 4 = spill on + sofstart + califa + neuland
\item tpat 9 = spill off + califa
\item tpat 10 = spill off + neuland
\end{itemize}
\end{appendices}
\end{document}
