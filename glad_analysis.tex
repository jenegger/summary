...
In figure blabla the calculated B-Field is plotted against the current. The error bars cannot be visualized, as the SEM is five magnitudes smaller than the value of the B-Field. This causes also the large chi\textunderscore square values. Nevertheless the fit seems to coincide quite well with the data point. The linear part dominates with an offset of about 0.05.
